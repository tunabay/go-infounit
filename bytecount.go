...
// package sync/atomic.
func AtomicCompareAndSwapByteCount(addr *ByteCount, old, val ByteCount) bool {
...
func (bc *ByteCount) MarshalJSON() ([]byte, error) {
	return json.Marshal(AtomicLoadByteCount(bc))
}
